<template>
  <div class="box" style="position: relative">
    ...
    <div class="top" v-if="type === 0">
      ...
      <p v-if="status === 1">
        <i-icon type="right" size="70" />
      </p>
      <p style="color: #80848f;" v-if="status === 1">设备绑定成功</p>
    </div>
    <!-- 蓝牙绑定 -->
...
export default {
  ...
  computed: {
    devCode() {
      console.log(store.state.devCode);
      return store.state.devCode;
    }
  },
  onUnload() {
    clearInterval(this.s);
