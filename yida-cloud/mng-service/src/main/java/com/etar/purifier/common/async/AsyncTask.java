...
public class AsyncTask {
    ...
    private final FilterInfoRepository infoRepository;
    ...
    @Autowired
    public AsyncTask(RestTemplate restTemplate, LoginLogService loginLogService, OperateLogService operateLogService, DeviceService deviceService, FilterInfoService filterInfoService, FilterInfoRepository infoRepository, UserService userService) {
...
//        kafkaTemplate.send("operateLog", gson.toJson(operateLog));
    ...
    @Async
    public void saveFilteInfo(List<FilterInfo> infoList){
